      ...
      <Container>
        ...
        >
          ...
          <div className="grid lg:grid-cols-2 gap-8 md:gap-10 items-center p-6 md:p-16 pb-28 md:pb-32">
              ...
              <AnimatePresence mode="wait">
                ...
                >
                  <div className="flex items-center gap-3 md:gap-4 mb-4 md:mb-6">
                    <div 
                      className="shrink-0 w-10 h-10 md:w-12 md:h-12 rounded-full bg-white border flex items-center justify-center text-xl md:text-2xl shadow-sm"
            ...
            {/* الجزء البصري (يمين) */}
            <div className="relative w-full overflow-hidden rounded-[24px] bg-[#f8fafc] shadow-lg order-1 lg:order-2" style={{ aspectRatio: '16/10' }}>
              <AnimatePresence mode="wait">
                <motion.img 
                  key={activeTab}
                  src={current.image} 
          ...
          <div className="absolute bottom-4 md:bottom-8 left-1/2  -translate-x-1/2 w-full max-w-max px-4">
            <div className="flex items-center justify-center gap-2 sm:gap-4 md:gap-6 px-4 py-3 md:py-4 bg-white/80 md:bg-transparent backdrop-blur-md md:backdrop-blur-none rounded-full shadow-sm md:shadow-none">
              {FEATURES_DATA.map((feat, index) => {
                ...
                return (
                  ...
                  >
                    <div
                      className="w-10 h-10 sm:w-12 sm:h-12 md:w-14 md:h-14 rounded-full flex items-center justify-center text-lg sm:text-xl md:text-2xl transition-all duration-300 border"
                      style={{
                    ...
                    <span className="absolute -top-10 scale-0 lg:group-hover:scale-100 transition-transform bg-black text-white text-[10px] px-2 py-1 rounded-md whitespace-nowrap">
                      {feat.title}
                    </span>
                  </button>
                );
