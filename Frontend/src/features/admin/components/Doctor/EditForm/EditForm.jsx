...
export default function EditForm({ title, initialData, onSave, onDelete, type }) {
  ...
  return (
    <section className="flex flex-col gap-5" aria-label={title}>
      ...
      {/* Action Buttons */}
      <div className="flex flex-col sm:flex-row items-center sm:justify-end gap-3 pt-4 border-t border-gray-100">
        <button type="button" className="w-full sm:w-auto px-4 py-2 text-[13px] font-semibold text-gray-600 bg-[#F6F7F8] rounded-[10px] cursor-pointer hover:bg-gray-200 transition-colors">Cancel</button>
