...
export default function SettingsProfile() {
  ...
  <div className="flex items-center gap-2">
    ...
    <h1 className="text-[24px] sm: font-bold text-black-main-text leading-tight">
      Settings & Profile
    </h1>
  </div>
        ...
        <div className="p-5 lg:p-8">
          ...
          <div className="flex justify-end mt-6">
            <button
              ...
              className="bg-brand-main cursor-pointer hover:bg-blue-700 text-white px-6 py-2.5 rounded-xl font-bold flex items-center gap-2 transition-colors text-[14px]"
            >
          ...
          <SettingRow
            ...
            action={
              <button
                ...
                className="text-[#155DFC] cursor-pointer font-bold text-[14px] hover:underline"
              >
                Change
              </button>
            }
        ...
        >
          ...
          >
            <button
              ...
              className="absolute cursor-pointer top-4 right-4 text-gray-400 hover:text-gray-700 transition-colors p-1 rounded-lg hover:bg-gray-100"
            >
              ✕
            </button>
            ...
            <div className="flex gap-3">
              <button
                onClick={() => setPwModal(false)}
                className="flex-1 py-3  cursor-pointer rounded-2xl border border-gray-200 text-gray-600 font-semibold hover:bg-gray-50 transition-colors text-[13px]"
              >
                Cancel
              </button>
              <button
                onClick={handleSavePassword}
                className="flex-1 py-3 cursor-pointer rounded-2xl bg-brand-main text-white font-bold flex items-center justify-center gap-2 hover:bg-blue-700 transition-colors text-[13px]"
              >
