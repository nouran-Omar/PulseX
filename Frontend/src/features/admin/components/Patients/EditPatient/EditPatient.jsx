...
import PATIENT_MOCK_BY_ID from './patientMockById';
...
export default function EditPatient() {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      ...
      navigate('/admin/patients/list', { state: { success: true, title: 'Updated Successfully' } });
    },
  });

  useEffect(() => {
    const mockData = PATIENT_MOCK_BY_ID[id] || PATIENT_MOCK_BY_ID[1];
