...
export default function ReportsManagement() {
  ...
  <div className="flex items-center gap-2.5 text-black-main-text">
    ...
    <h1 className="text-[24px] sm:font-bold leading-tight">
      Reports Management
    </h1>
  </div>
  ...
  <p className="text-[18px] text-gray-text-dim2  leading-relaxed">
    Review and manage reported content from the community.
      ...
      {/* ── Stat Cards ── */}
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 px-2 sm:px-8 py-6 gap-3">
        {[
  ...
  return (
    <article className="bg-white rounded-2xl shadow-[0px_1px_3px_0px_rgba(0,0,0,0.10),0px_1px_2px_-1px_rgba(0,0,0,0.10)] outline outline-[0.8px] outline-gray-200 px-6 pt-6 pb-5 flex flex-col gap-4">
      ...
      <div className="flex flex-col sm:flex-row flex-wrap gap-2 pt-1 w-full">
        ...
        <button
          onClick={onView}
          className="flex flex-1 sm:flex-none justify-center cursor-pointer items-center gap-1.5 px-4 py-2 text-[14px] font-semibold text-white bg-[#155DFC] rounded-lg hover:bg-[#0913C3] transition-colors"
        >
        ...
        {isPending && (
          <>
            <button
              onClick={onDelete}
              className="flex flex-1 sm:flex-none justify-center cursor-pointer items-center gap-1.5 px-4 py-2 text-[14px] font-semibold text-white bg-[#E7000B] rounded-lg hover:bg-[#C10007] transition-colors"
            >
              <HiOutlineTrash size={14} /> Delete Content
            </button>
            <button
              onClick={onMarkReviewed}
              className="flex flex-1 sm:flex-none justify-center cursor-pointer items-center gap-1.5 px-4 py-2 text-[14px] font-semibold text-white bg-[#00A63E] rounded-lg hover:bg-[#008236] transition-colors"
            >
              <HiOutlineCheckCircle size={14} /> Mark Reviewed
            </button>
            <button
              onClick={onDismiss}
              className="flex flex-1 sm:flex-none justify-center cursor-pointer items-center gap-1.5 px-4 py-2 text-[14px] font-semibold text-white bg-gray-600 rounded-lg hover:bg-gray-700 transition-colors"
            >
        ...
        {isReviewed && (
          <>
            ...
            <button
              onClick={onDismiss}
              className="flex flex-1 sm:flex-none justify-center cursor-pointer items-center gap-1.5 px-4 py-2 text-[14px] font-semibold text-[#4A5565] bg-[#F3F4F6] rounded-lg hover:bg-[#E5E7EB] transition-colors"
            >
              <HiOutlineXCircle size={14} /> Dismiss
            </button>
            <button
              onClick={onReopen}
              className="flex flex-1 sm:flex-none justify-center cursor-pointer items-center gap-1.5 px-4 py-2 text-[12px] font-semibold text-[#CA3500] bg-[#FFEDD4] rounded-lg hover:bg-orange-200 transition-colors"
            >
