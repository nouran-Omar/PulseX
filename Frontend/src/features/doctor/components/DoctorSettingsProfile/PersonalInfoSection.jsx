      ...
      <div className="p-4 sm:p-6">
        <div className="flex flex-col lg:flex-row gap-6 sm:gap-8">
          <div className="flex flex-col items-center gap-2 shrink-0 w-full lg:w-auto">
            ...
            >
              <img
                src={photo || `https://ui-avatars.com/api/?name=${encodeURIComponent(`${form.firstName} ${form.lastName}`.trim() || 'Doctor')}&background=333CF5&color=fff&size=128`}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 flex-1">
            ...
            <div className="sm:col-span-2">
              <InputField
                ...
                onChange={v => handleField('yearsExperience', v)}
