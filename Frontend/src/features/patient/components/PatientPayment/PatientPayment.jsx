        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <div 
              ...
              className={`bg-white p-6 rounded-[24px] border-2 cursor-pointer flex items-center justify-between transition-all ${method === 'cash' ? 'border-[#3B5BFE]' : 'border-gray-200'}`}
            >
...
<path d="M2 10H22" stroke="#333CF5" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
              ...
              <div className={`w-6 h-6 rounded-full border-2 flex items-center justify-center ${method === 'cash' ? 'border-[#3B5BFE]' : 'border-gray-200'}`}>
            ...
            <div 
              ...
              className={`bg-white p-6 rounded-[24px] border-2 cursor-pointer flex items-center justify-between transition-all ${method === 'credit' ? 'border-[#3B5BFE]' : 'border-gray-200'}`}
            >
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 bg-slate-50 rounded-xl flex items-center justify-center border border-slate-100">
                  <span className="text-xl"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
