...
const PatientSidebar = ({ onClose, onLogout }) => {
  return (
    ...
    <div className="group flex flex-col w-full sm:w-[260px] md:w-[280px] max-w-full h-[100dvh] sm:h-full min-h-0 bg-white rounded-[24px] overflow-hidden border border-gray-100/50 shadow-sm transition-all duration-300 ease-in-out">
      
      {/* ── Logo ── */}
      <div className="flex items-center gap-2 px-4 py-3 shrink-0">
        <img src={logo} alt="Logo" className="w-6 h-6 shrink-0" onError={e => e.target.style.display='none'} />
        <span className="text-[24px] font-bold text-black-main-text tracking-tight">
