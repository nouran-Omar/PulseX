...
const FALLBACK_STORY_IMAGE = 'https://images.unsplash.com/photo-1490645935967-10de6ba17061?auto=format&fit=crop&w=300&q=80';
...
function getInitialFormFromPatient(patient) {
...
function getPatientStories(patient) {
  ...
  return patient.stories.map((story, index) => ({
    ...
    image: story?.image ?? story?.coverImage ?? story?.thumbnail ?? FALLBACK_STORY_IMAGE,
  }));
}

function getStoriesWithFallback(patient) {
