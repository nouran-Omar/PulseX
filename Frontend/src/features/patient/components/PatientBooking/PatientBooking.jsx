...
const PatientBooking = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-start bg-[#F9FAFB] p-4 sm:p-6 lg:p-8">
      ...
      <div className="w-full max-w-5xl bg-white rounded-[32px] shadow-sm border border-gray-100 overflow-hidden mb-6">
        <div className="flex flex-col lg:flex-row">
          ...
          {/* ── LEFT SIDEBAR ── */}
          <div className="w-full lg:w-72 border-b lg:border-b-0 lg:border-r border-gray-100 p-6 sm:p-8 flex flex-col items-start gap-6">
            
            {/* Doctor Info - محاذاة للوسط في الموبايل ولليسار في الشاشات الكبيرة */}
            ...
            {/* Stepper - متجاوب بجانبي (أفقي) عالموبايل و طولي عالشاشات الكبيرة */}
            <div className="flex flex-row lg:flex-col items-start justify-between sm:justify-center gap-2 lg:gap-0 w-full mt-4 lg:pl-1 overflow-x-auto pb-2 lg:pb-0 scrollbar-hide">
              {/* Step 1 */}
            ...
            <div className="flex flex-col xl:flex-row gap-8 sm:gap-10">
              ...
              <div className="flex-1">
                <div className="flex items-center justify-between mb-6 sm:mb-8">
                  <button onClick={goPrevMonth} className="cursor-pointer w-9 h-9 rounded-full bg-gray-50 flex items-center justify-center hover:bg-gray-100 transition">
                    <HiChevronLeft className="text-gray-400" />
                  </button>
                  <span className="text-base font-bold text-black-main-text">{calHeaderLabel}</span>
                  <button onClick={goNextMonth} className="cursor-pointer w-9 h-9 rounded-full bg-brand-main flex items-center justify-center shadow-lg shadow-blue-100">
              ...
              {/* Time Slots */}
              <div className="w-full xl:w-56 shrink-0 mt-6 xl:mt-0">
                <p className="text-[16px] font-normal text-[#010218] mb-5 text-center xl:text-left">{dayOfWeekLabel}</p>
