...
import { TbStethoscope, TbClipboardText, TbFileText } from 'react-icons/tb';
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-5">
            ...
            <div className="flex items-center gap-3 text-white">
              ...
              <div>
                ...
                <h4 className="text-[18px] font-bold m-0 leading-tight">{data.doc}</h4>
            ...
            <div className="flex items-center gap-3 text-white">
              ...
              <div>
                ...
                <h4 className="text-[18px] font-bold m-0 leading-tight">{data.patientName}</h4>
            ...
            <div className="flex items-center gap-3 text-white">
              ...
              <div>
                ...
                <h4 className="text-[18px] font-bold m-0 leading-tight">{data.date}</h4>
                <p className="text-[14px] opacity-80 m-0 flex items-center gap-1">
                  <HiOutlineClock className="text-[14px]" /> {data.time}
                </p>
              </div>
            </div>
        ...
        <div className="p-6 sm:p-10 flex flex-col gap-8">
          ...
          <section>
            ...
            >
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                <path d="M8.75082 17.0832L17.0841 8.74984C17.4735 8.36823 17.7834 7.91322 17.9959 7.41111C18.2083 6.90899 18.3191 6.36975 18.3219 5.82454C18.3246 5.27934 18.2193 4.739 18.0119 4.23477C17.8046 3.73054 17.4993 3.27242 17.1138 2.8869C16.7282 2.50137 16.2701 2.1961 15.7659 1.98873C15.2617 1.78136 14.7213 1.67601 14.1761 1.67876C13.6309 1.68152 13.0917 1.79232 12.5895 2.00478C12.0874 2.21723 11.6324 2.52711 11.2508 2.91651L2.91748 11.2498C2.52809 11.6314 2.21821 12.0865 2.00575 12.5886C1.7933 13.0907 1.68249 13.6299 1.67974 14.1751C1.67699 14.7203 1.78234 15.2607 1.98971 15.7649C2.19708 16.2691 2.50235 16.7273 2.88787 17.1128C3.27339 17.4983 3.73151 17.8036 4.23575 18.0109C4.73998 18.2183 5.28032 18.3237 5.82552 18.3209C6.37072 18.3182 6.90997 18.2074 7.41208 17.9949C7.91419 17.7824 8.36921 17.4726 8.75082 17.0832Z"
                  stroke="#9810FA" strokeWidth="1.66667" strokeLinecap="round" strokeLinejoin="round"/>
                <path d="M7.07812 7.0835L12.9115 12.9168"
                  stroke="#9810FA" strokeWidth="1.66667" strokeLinecap="round" strokeLinejoin="round"/>
              </svg>
              ...
              {data.medications.map((med, i) => (
                ...
                >
                  ...
                  <div className="flex-1">
                    <h5 className="text-[18px] font-bold text-black-main-text m-0 mb-1">{med.name}</h5>
                    <p className="text-[14px] text-[#4A5565] m-0 mb-4">Dosage: {med.dose}</p>
                    <div className="flex gap-4 flex-wrap">
                      <div className="flex-1 min-w-[120px] bg-[#fafafa] border border-[#f3f4f6] rounded-xl p-3">
                        <span className="text-[12px] text-[#4A5565] block mb-1">Frequency</span>
                      ...
                      <div className="flex-1 min-w-[100px] bg-[#fafafa] border border-[#f3f4f6] rounded-xl p-3">
                        <span className="text-[12px] text-[#4A5565] block mb-1">Duration</span>
            ...
            <div className="flex items-start gap-3 bg-[#FFFBEB] border border-[#FEE685] rounded-xl p-4 mt-5">
              ...
              <div>
                <p className="text-[16px] font-bold text-[#7B3306] m-0 mb-1">Important Instructions</p>
          ...
          <section>
            ...
            >
              <TbClipboardText className="text-[16px] text-[#00A63E]" />
                ...
                >
                  <div className="flex items-center justify-between gap-4 flex-wrap">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <h6 className="text-[16px] font-semibold text-black-main-text m-0">{lab.name}</h6>
                        {lab.note && (
                          <p className="text-[14px] text-[#4A5565] m-0 mt-[2px]">Note: {lab.note}</p>
                        )}
                      </div>
                    </div>

                    {/* ── Upload Result → navigates directly to /patient/records ── */}
                    <button
            ...
            <div className="flex items-start gap-3 bg-[#eff6ff] border border-[#dbeafe] rounded-xl p-4 mt-4">
              ...
              <div>
                <p className="text-[16px] font-bold text-[#1C398E] m-0 mb-1">Lab Visit Instructions</p>
          ...
          <section>
            ...
            >
              <TbFileText className="text-[16px] text-[#F54900]" />
              Clinical Notes &amp; Instructions
            </div>
            <div className="bg-[#f9fafb] border border-[#f3f4f6] rounded-xl p-5 text-[16px] text-[#364153] leading-relaxed">
              {data.clinicalNotes}
            </div>
          </section>
