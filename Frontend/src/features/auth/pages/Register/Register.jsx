      ...
      <div className="max-w-[1200px] mx-auto py-10 px-4 flex flex-col items-center">
        ...
        <div className="bg-white p-6 md:p-10 rounded-[28px] shadow-[0px_10px_60px_rgba(0,0,0,0.03)] w-full max-w-[780px] border border-gray-50">
            ...
            <div className="mt-8">
              ...
              <div className="flex gap-5">
                {['Male', 'Female'].map((g) => (
                  <label
                    key={g}
                    className={`flex items-center justify-center gap-3 px-6 py-4 rounded-full border cursor-pointer transition-all font-bold text-[14px] bg-white ${
          ...
          <div className="mt-12 p-8 bg-[#F1F5F9] rounded-[24px] text-center">
            ...
            <p className="text-[14px] text-[#64748B] mt-2 mb-6 text-center">If you're an existing patient, sign in to access your records.</p>
